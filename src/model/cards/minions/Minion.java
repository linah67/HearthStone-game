...
public class Minion extends Card implements Cloneable {
	...
	public String toString() {
		String n="linah";
		String x="<html>"+getName()+"<br>MC: "+this.getManaCost()+"<br>Rarity: "+this.getRarity()+"<br>Attack: "+this.getAttack()+"<br>HP: "+this.getCurrentHP()+"<br>Taunt: "+this.isTaunt()+"<br>DS: "+this.isDivine()+"<br>Charge: "+!this.isSleeping()+"<br>";
		return x;
