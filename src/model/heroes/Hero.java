...
public abstract class Hero implements MinionListener {
	...
	public String toString() {
		return"<html>"+getName()+"<br>CurrentHp: "+this.getCurrentHP()+"<br>CurrentManaCrystals:  "+this.getCurrentManaCrystals()+"<br>TotalManaCrystals: "+this.getTotalManaCrystals() +"<br>Deck: "+this.getDeck().size();
		}
